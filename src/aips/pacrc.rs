...
pub struct W(crate::W<PACRC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PACRC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PACRC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PACRC_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Trusted Protect\n\nValue on reset: 0"]
...
impl crate::Writable for PACRC_SPEC {
    type Writer = W;
}
