...
pub struct R(crate::R<PACRE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PACRE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PACRE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PACRE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PACRE` writer"]
pub struct W(crate::W<PACRE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PACRE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PACRE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PACRE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Trusted Protect\n\nValue on reset: 0"]
...
#[doc = "Peripheral Access Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pacre](index.html) module"]
pub struct PACRE_SPEC;
impl crate::RegisterSpec for PACRE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pacre::R](R) reader structure"]
impl crate::Readable for PACRE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pacre::W](W) writer structure"]
impl crate::Writable for PACRE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PACRE to value 0"]
impl crate::Resettable for PACRE_SPEC {
    #[inline(always)]
