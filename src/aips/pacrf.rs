...
pub struct R(crate::R<PACRF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PACRF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PACRF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PACRF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PACRF` writer"]
pub struct W(crate::W<PACRF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PACRF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PACRF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PACRF_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Trusted Protect\n\nValue on reset: 0"]
...
#[doc = "Peripheral Access Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pacrf](index.html) module"]
pub struct PACRF_SPEC;
impl crate::RegisterSpec for PACRF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pacrf::R](R) reader structure"]
impl crate::Readable for PACRF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pacrf::W](W) writer structure"]
impl crate::Writable for PACRF_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PACRF to value 0"]
impl crate::Resettable for PACRF_SPEC {
    #[inline(always)]
