...
pub struct R(crate::R<PACRI_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PACRI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PACRI_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PACRI_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PACRI` writer"]
pub struct W(crate::W<PACRI_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PACRI_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PACRI_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PACRI_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Trusted Protect\n\nValue on reset: 0"]
...
#[doc = "Peripheral Access Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pacri](index.html) module"]
pub struct PACRI_SPEC;
impl crate::RegisterSpec for PACRI_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pacri::R](R) reader structure"]
impl crate::Readable for PACRI_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pacri::W](W) writer structure"]
impl crate::Writable for PACRI_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PACRI to value 0"]
impl crate::Resettable for PACRI_SPEC {
    #[inline(always)]
