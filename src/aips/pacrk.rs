...
pub struct R(crate::R<PACRK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PACRK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PACRK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PACRK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PACRK` writer"]
pub struct W(crate::W<PACRK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PACRK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PACRK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PACRK_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Trusted Protect\n\nValue on reset: 0"]
...
#[doc = "Peripheral Access Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pacrk](index.html) module"]
pub struct PACRK_SPEC;
impl crate::RegisterSpec for PACRK_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pacrk::R](R) reader structure"]
impl crate::Readable for PACRK_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pacrk::W](W) writer structure"]
impl crate::Writable for PACRK_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PACRK to value 0"]
impl crate::Resettable for PACRK_SPEC {
    #[inline(always)]
