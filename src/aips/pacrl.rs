...
pub struct R(crate::R<PACRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PACRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PACRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PACRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PACRL` writer"]
pub struct W(crate::W<PACRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PACRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PACRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PACRL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Trusted Protect\n\nValue on reset: 0"]
...
#[doc = "Peripheral Access Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pacrl](index.html) module"]
pub struct PACRL_SPEC;
impl crate::RegisterSpec for PACRL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pacrl::R](R) reader structure"]
impl crate::Readable for PACRL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pacrl::W](W) writer structure"]
impl crate::Writable for PACRL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PACRL to value 0"]
impl crate::Resettable for PACRL_SPEC {
    #[inline(always)]
