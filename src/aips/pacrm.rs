...
pub struct R(crate::R<PACRM_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PACRM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PACRM_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PACRM_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PACRM` writer"]
pub struct W(crate::W<PACRM_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PACRM_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PACRM_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PACRM_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Trusted Protect\n\nValue on reset: 0"]
...
#[doc = "Peripheral Access Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pacrm](index.html) module"]
pub struct PACRM_SPEC;
impl crate::RegisterSpec for PACRM_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pacrm::R](R) reader structure"]
impl crate::Readable for PACRM_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pacrm::W](W) writer structure"]
impl crate::Writable for PACRM_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PACRM to value 0"]
impl crate::Resettable for PACRM_SPEC {
    #[inline(always)]
