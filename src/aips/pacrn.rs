...
pub struct R(crate::R<PACRN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PACRN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PACRN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PACRN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PACRN` writer"]
pub struct W(crate::W<PACRN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PACRN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PACRN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PACRN_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Trusted Protect\n\nValue on reset: 0"]
...
#[doc = "Peripheral Access Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pacrn](index.html) module"]
pub struct PACRN_SPEC;
impl crate::RegisterSpec for PACRN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pacrn::R](R) reader structure"]
impl crate::Readable for PACRN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pacrn::W](W) writer structure"]
impl crate::Writable for PACRN_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PACRN to value 0"]
impl crate::Resettable for PACRN_SPEC {
    #[inline(always)]
