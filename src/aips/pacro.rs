...
pub struct R(crate::R<PACRO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PACRO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PACRO_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PACRO_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PACRO` writer"]
pub struct W(crate::W<PACRO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PACRO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PACRO_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PACRO_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Trusted Protect\n\nValue on reset: 0"]
...
#[doc = "Peripheral Access Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pacro](index.html) module"]
pub struct PACRO_SPEC;
impl crate::RegisterSpec for PACRO_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pacro::R](R) reader structure"]
impl crate::Readable for PACRO_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pacro::W](W) writer structure"]
impl crate::Writable for PACRO_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PACRO to value 0"]
impl crate::Resettable for PACRO_SPEC {
    #[inline(always)]
