...
pub struct R(crate::R<PACRP_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PACRP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PACRP_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PACRP_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PACRP` writer"]
pub struct W(crate::W<PACRP_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PACRP_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PACRP_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PACRP_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Trusted Protect\n\nValue on reset: 0"]
...
#[doc = "Peripheral Access Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pacrp](index.html) module"]
pub struct PACRP_SPEC;
impl crate::RegisterSpec for PACRP_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pacrp::R](R) reader structure"]
impl crate::Readable for PACRP_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pacrp::W](W) writer structure"]
impl crate::Writable for PACRP_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PACRP to value 0"]
impl crate::Resettable for PACRP_SPEC {
    #[inline(always)]
