...
pub struct R(crate::R<DMA_TCD_CITER_ELINKNO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DMA_TCD_CITER_ELINKNO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DMA_TCD_CITER_ELINKNO_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DMA_TCD_CITER_ELINKNO_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TCD%s_CITER_ELINKNO` writer"]
pub struct W(crate::W<DMA_TCD_CITER_ELINKNO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DMA_TCD_CITER_ELINKNO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DMA_TCD_CITER_ELINKNO_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DMA_TCD_CITER_ELINKNO_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "TCD Current Minor Loop Link, Major Loop Count (Channel Linking Disabled)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [dma_tcd_citer_elinkno](index.html) module"]
pub struct DMA_TCD_CITER_ELINKNO_SPEC;
impl crate::RegisterSpec for DMA_TCD_CITER_ELINKNO_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [dma_tcd_citer_elinkno::R](R) reader structure"]
impl crate::Readable for DMA_TCD_CITER_ELINKNO_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dma_tcd_citer_elinkno::W](W) writer structure"]
impl crate::Writable for DMA_TCD_CITER_ELINKNO_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TCD%s_CITER_ELINKNO to value 0"]
impl crate::Resettable for DMA_TCD_CITER_ELINKNO_SPEC {
    #[inline(always)]
