...
#[doc = "Field `CLK_DIV` reader - Selected low power clock source for running the EWM counter can be prescaled as below"]
...
#[doc = "Field `CLK_DIV` writer - Selected low power clock source for running the EWM counter can be prescaled as below"]
...
impl R {
    #[doc = "Bits 0:7 - Selected low power clock source for running the EWM counter can be prescaled as below"]
    #[inline(always)]
