...
#[doc = "Program Flash Protection Registers"]
pub mod fprot;
#[doc = "Execute-only Access Registers\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [xacc](xacc) module"]
...
#[doc = "Execute-only Access Registers"]
pub mod xacc;
#[doc = "Supervisor-only Access Registers\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sacc](sacc) module"]
...
#[doc = "Supervisor-only Access Registers"]
pub mod sacc;
#[doc = "Flash Access Segment Size Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [facss](facss) module"]
...
#[doc = "Flash Access Segment Size Register"]
pub mod facss;
#[doc = "Flash Access Segment Number Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [facsn](facsn) module"]
