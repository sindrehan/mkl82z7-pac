...
pub enum FACK_A {
    ...
    _0 = 0,
    #[doc = "1: Writing 0 to TXAK after receiving a data byte generates an ACK. Writing 1 to TXAK after receiving a data byte generates a NACK. Enable I2C_S2\\[DFEN\\]
...
impl<'a> FACK_W<'a> {
    ...
    #[doc = "Writing 0 to TXAK after receiving a data byte generates an ACK. Writing 1 to TXAK after receiving a data byte generates a NACK. Enable I2C_S2\\[DFEN\\]
in the master receive mode."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
