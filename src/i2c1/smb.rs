...
pub enum FACKR {
    ...
    _0,
    #[doc = "Writing 0 to TXAK after receiving a data byte generates an ACK. Writing 1 to TXAK after receiving a data byte generates a NACK. Enable I2C_S2\\[DFEN\\] in the master receive mode."]
    _1,
}
impl FACKR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
