#[doc = "Reader of register FILT3"]
pub type R = crate::R<u8, super::FILT3>;
#[doc = "Writer for register FILT3"]
pub type W = crate::W<u8, super::FILT3>;
#[doc = "Register FILT3 `reset()`'s with value 0"]
impl crate::ResetValue for super::FILT3 {
    type Type = u8;
    #[inline(always)]
...
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum FILTF_A {
    #[doc = "0: Pin Filter 3 was not a wakeup source"]
    _0 = 0,
    #[doc = "1: Pin Filter 3 was a wakeup source"]
    _1 = 1,
}
...
impl<'a> FILTF_W<'a> {
    ...
    #[doc = "Pin Filter 3 was not a wakeup source"]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(FILTF_A::_0)
    }
    #[doc = "Pin Filter 3 was a wakeup source"]
    #[inline(always)]
