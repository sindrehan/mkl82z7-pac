#[doc = "Reader of register FILT4"]
pub type R = crate::R<u8, super::FILT4>;
#[doc = "Writer for register FILT4"]
pub type W = crate::W<u8, super::FILT4>;
#[doc = "Register FILT4 `reset()`'s with value 0"]
impl crate::ResetValue for super::FILT4 {
    type Type = u8;
    #[inline(always)]
