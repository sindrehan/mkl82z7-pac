...
pub enum RXRTSE_A {
    ...
    _0 = 0,
    #[doc = "1: RTS assertion is configured by the RTSWATER field"]
    _1 = 1,
}
...
impl<'a> RXRTSE_W<'a> {
    ...
    #[doc = "RTS assertion is configured by the RTSWATER field"]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
...
#[repr(u8)]
pub enum RTSWATER_A {
    #[doc = "0: RTS asserts when the receiver FIFO is full or receiving a character that causes the FIFO to become full."]
    _0 = 0,
    #[doc = "1: RTS asserts when the receive FIFO is less than or equal to the RXWATER configuration and negates when the receive FIFO is greater than the RXWATER configuration."]
    _1 = 1,
}
impl From<RTSWATER_A> for u8 {
    #[inline(always)]
    fn from(variant: RTSWATER_A) -> Self {
        variant as _
    }
}
#[doc = "Field `RTSWATER` reader - Receive RTS Configuration"]
pub struct RTSWATER_R(crate::FieldReader<u8, RTSWATER_A>);
impl RTSWATER_R {
    ...
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> Option<RTSWATER_A> {
        match self.bits {
            0 => Some(RTSWATER_A::_0),
            1 => Some(RTSWATER_A::_1),
            _ => None,
        }
    }
    #[doc = "Checks if the value of the field is `_0`"]
...
impl core::ops::Deref for RTSWATER_R {
    type Target = crate::FieldReader<u8, RTSWATER_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> RTSWATER_W<'a> {
    #[doc = r"Writes `variant` to the field"]
    #[inline(always)]
    pub fn variant(self, variant: RTSWATER_A) -> &'a mut W {
        unsafe { self.bits(variant.into()) }
    }
    #[doc = "RTS asserts when the receiver FIFO is full or receiving a character that causes the FIFO to become full."]
    #[inline(always)]
    pub fn _0(self) -> &'a mut W {
        self.variant(RTSWATER_A::_0)
    }
    #[doc = "RTS asserts when the receive FIFO is less than or equal to the RXWATER configuration and negates when the receive FIFO is greater than the RXWATER configuration."]
    #[inline(always)]
    pub fn _1(self) -> &'a mut W {
        self.variant(RTSWATER_A::_1)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
impl R {
    ...
    #[doc = "Bits 8:15 - Receive RTS Configuration"]
    #[inline(always)]
    pub fn rtswater(&self) -> RTSWATER_R {
        RTSWATER_R::new(((self.bits >> 8) & 0xff) as u8)
    }
