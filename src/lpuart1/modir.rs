...
#[doc = "Possible values of the field `RTSWATER`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum RTSWATERR {
...
impl RTSWATERR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            RTSWATERR::_0 => 0,
            RTSWATERR::_1 => 1,
            RTSWATERR::_Reserved(bits) => bits,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: u8) -> RTSWATERR {
        match value {
            0 => RTSWATERR::_0,
            1 => RTSWATERR::_1,
            i => RTSWATERR::_Reserved(i),
        }
    }
    #[doc = "Checks if the value of the field is `_0`"]
    #[inline]
...
#[doc = "Values that can be written to the field `RTSWATER`"]
pub enum RTSWATERW {
    #[doc = "RTS asserts when the receiver FIFO is full or receiving a character that causes the FIFO to become full."]
    _0,
    #[doc = "RTS asserts when the receive FIFO is less than or equal to the RXWATER configuration and negates when the receive FIFO is greater than the RXWATER configuration."]
...
impl<'a> _RTSWATERW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: RTSWATERW) -> &'a mut W {
        unsafe { self.bits(variant._bits()) }
    }
    #[doc = "RTS asserts when the receiver FIFO is full or receiving a character that causes the FIFO to become full."]
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(RTSWATERW::_0)
    }
    #[doc = "RTS asserts when the receive FIFO is less than or equal to the RXWATER configuration and negates when the receive FIFO is greater than the RXWATER configuration."]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(RTSWATERW::_1)
    }
    #[doc = r" Writes raw bits to the field"]
    #[inline]
