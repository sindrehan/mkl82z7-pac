#[doc = "Reader of register LTC0_PKA0_6"]
pub type R = crate::R<u32, super::LTC0_PKA0_6>;
#[doc = "Writer for register LTC0_PKA0_6"]
pub type W = crate::W<u32, super::LTC0_PKA0_6>;
#[doc = "Register LTC0_PKA0_6 `reset()`'s with value 0"]
impl crate::ResetValue for super::LTC0_PKA0_6 {
    type Type = u32;
    #[inline(always)]
