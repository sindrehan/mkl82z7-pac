#[doc = "Reader of register LTC0_PKA1_8"]
pub type R = crate::R<u32, super::LTC0_PKA1_8>;
#[doc = "Writer for register LTC0_PKA1_8"]
pub type W = crate::W<u32, super::LTC0_PKA1_8>;
#[doc = "Register LTC0_PKA1_8 `reset()`'s with value 0"]
impl crate::ResetValue for super::LTC0_PKA1_8 {
    type Type = u32;
    #[inline(always)]
