#[doc = "Reader of register LTC0_PKN2_1"]
pub type R = crate::R<u32, super::LTC0_PKN2_1>;
#[doc = "Writer for register LTC0_PKN2_1"]
pub type W = crate::W<u32, super::LTC0_PKN2_1>;
#[doc = "Register LTC0_PKN2_1 `reset()`'s with value 0"]
impl crate::ResetValue for super::LTC0_PKN2_1 {
    type Type = u32;
    #[inline(always)]
