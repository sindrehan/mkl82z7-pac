#[doc = "Reader of register LTC0_PKN2_2"]
pub type R = crate::R<u32, super::LTC0_PKN2_2>;
#[doc = "Writer for register LTC0_PKN2_2"]
pub type W = crate::W<u32, super::LTC0_PKN2_2>;
#[doc = "Register LTC0_PKN2_2 `reset()`'s with value 0"]
impl crate::ResetValue for super::LTC0_PKN2_2 {
    type Type = u32;
    #[inline(always)]
