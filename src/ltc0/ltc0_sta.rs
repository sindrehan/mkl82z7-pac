...
#[doc = "Possible values of the field `AB`"]
...
#[doc = "Possible values of the field `DB`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum DBR {
    #[doc = "DESA Idle"]
    _0,
