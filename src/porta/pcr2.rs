...
pub struct ODE_R(crate::FieldReader<bool, ODE_A>);
impl ODE_R {
    pub(crate) fn new(bits: bool) -> Self {
        ODE_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for ODE_R {
    type Target = crate::FieldReader<bool, ODE_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub enum IRQC_A {
    ...
    _0011 = 3,
    #[doc = "5: Flag sets on rising edge."]
    _0101 = 5,
    #[doc = "6: Flag sets on falling edge."]
    _0110 = 6,
    #[doc = "7: Flag sets on either edge."]
    _0111 = 7,
    ...
    _1100 = 12,
    #[doc = "13: Enable active high trigger output, flag is disabled. \\[The trigger output goes to the trigger mux, which allows pins to trigger other peripherals (configurable polarity; 1 pin per port; if multiple pins are configured, then they are ORed together to create the trigger)\\]"]
    _1101 = 13,
    #[doc = "14: Enable active low trigger output, flag is disabled."]
    _1110 = 14,
}
...
impl IRQC_R {
    ...
    pub fn variant(&self) -> Option<IRQC_A> {
        match self.bits {
            ...
            13 => Some(IRQC_A::_1101),
            14 => Some(IRQC_A::_1110),
            _ => None,
        }
    }
...
impl<'a> IRQC_W<'a> {
    ...
    #[doc = "Flag sets on rising edge."]
    #[inline(always)]
    pub fn _0101(self) -> &'a mut W {
        self.variant(IRQC_A::_0101)
    }
    #[doc = "Flag sets on falling edge."]
    #[inline(always)]
    pub fn _0110(self) -> &'a mut W {
        self.variant(IRQC_A::_0110)
    }
    #[doc = "Flag sets on either edge."]
    #[inline(always)]
    pub fn _0111(self) -> &'a mut W {
        self.variant(IRQC_A::_0111)
    }
    ...
    #[doc = "Enable active high trigger output, flag is disabled. \\[The trigger output goes to the trigger mux, which allows pins to trigger other peripherals (configurable polarity; 1 pin per port; if multiple pins are configured, then they are ORed together to create the trigger)\\]"]
    #[inline(always)]
    pub fn _1101(self) -> &'a mut W {
        self.variant(IRQC_A::_1101)
    }
    #[doc = "Enable active low trigger output, flag is disabled."]
    #[inline(always)]
    pub fn _1110(self) -> &'a mut W {
        self.variant(IRQC_A::_1110)
    }
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
...
#[doc = "`reset()` method sets PCR2 to value 0x0703"]
