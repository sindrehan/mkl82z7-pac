...
pub struct RegisterBlock {
    ...
    pub dlpr: crate::Reg<dlpr::DLPR_SPEC>,
    _reserved30: [u8; 0x6c],
    #[doc = "0x200..0x240 - RX Buffer Data Register"]
    pub rbdr: [crate::Reg<rbdr::RBDR_SPEC>; 16],
    _reserved31: [u8; 0xc0],
...
pub mod sfb2ad;
#[doc = "DLPR register accessor: an alias for `Reg<DLPR_SPEC>`"]
