#[doc = "Reader of register BUF1CR"]
pub type R = crate::R<u32, super::BUF1CR>;
#[doc = "Writer for register BUF1CR"]
pub type W = crate::W<u32, super::BUF1CR>;
#[doc = "Register BUF1CR `reset()`'s with value 0x03"]
impl crate::ResetValue for super::BUF1CR {
    type Type = u32;
    #[inline(always)]
