...
impl W {
    ...
    #[doc = "Bits 8:14 - AHB data transfer size"]
    #[inline]
    pub fn adatsz(&mut self) -> _ADATSZW {
        _ADATSZW { w: self }
    }
    #[doc = "Bit 31 - All master enable"]
    #[inline]
    pub fn allmst(&mut self) -> _ALLMSTW {
        _ALLMSTW { w: self }
    }
}
