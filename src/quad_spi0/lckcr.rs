#[doc = "Reader of register LCKCR"]
pub type R = crate::R<u32, super::LCKCR>;
#[doc = "Writer for register LCKCR"]
pub type W = crate::W<u32, super::LCKCR>;
#[doc = "Register LCKCR `reset()`'s with value 0x02"]
impl crate::ResetValue for super::LCKCR {
    type Type = u32;
    #[inline(always)]
