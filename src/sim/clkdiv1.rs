...
#[doc = "Reader of field `OUTDIV5`"]
pub type OUTDIV5_R = crate::R<u8, OUTDIV5_A>;
impl OUTDIV5_R {
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> crate::Variant<u8, OUTDIV5_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(OUTDIV5_A::_0000),
            1 => Val(OUTDIV5_A::_0001),
            i => Res(i),
        }
    }
...
#[doc = "Write proxy for field `OUTDIV5`"]
