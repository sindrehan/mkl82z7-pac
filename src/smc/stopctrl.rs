...
#[doc = "Possible values of the field `LPOPO`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum LPOPOR {
...
impl LPOPOR {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> LPOPOR {
        match value {
            false => LPOPOR::_0,
            true => LPOPOR::_1,
        }
...
#[doc = "Values that can be written to the field `LPOPO`"]
pub enum LPOPOW {
    #[doc = "LPO clock is enabled in LLS/VLLSx"]
    _0,
    #[doc = "LPO clock is disabled in LLS/VLLSx"]
...
#[doc = r" Proxy"]
pub struct _LPOPOW<'a> {
    w: &'a mut W,
}
impl<'a> _LPOPOW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: LPOPOW) -> &'a mut W {
        {
    ...
    pub fn _0(self) -> &'a mut W {
        self.variant(LPOPOW::_0)
    }
    #[doc = "LPO clock is disabled in LLS/VLLSx"]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(LPOPOW::_1)
    }
