...
pub struct R(crate::R<SPI0_CTAR_SLAVE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPI0_CTAR_SLAVE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPI0_CTAR_SLAVE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPI0_CTAR_SLAVE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CTAR_SLAVE` writer"]
pub struct W(crate::W<SPI0_CTAR_SLAVE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI0_CTAR_SLAVE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPI0_CTAR_SLAVE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI0_CTAR_SLAVE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Clock Phase\n\nValue on reset: 0"]
...
#[doc = "Clock and Transfer Attributes Register (In Slave Mode)\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [spi0_ctar_slave](index.html) module"]
pub struct SPI0_CTAR_SLAVE_SPEC;
impl crate::RegisterSpec for SPI0_CTAR_SLAVE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spi0_ctar_slave::R](R) reader structure"]
impl crate::Readable for SPI0_CTAR_SLAVE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [spi0_ctar_slave::W](W) writer structure"]
impl crate::Writable for SPI0_CTAR_SLAVE_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CTAR_SLAVE to value 0x7800_0000"]
impl crate::Resettable for SPI0_CTAR_SLAVE_SPEC {
    #[inline(always)]
