...
pub struct RegisterBlock {
    ...
    pub tcr: TCR,
    #[doc = "Clock and Transfer Attributes Register (In Slave Mode) Clock and Transfer Attributes Register (In Master Mode)"]
    pub ctar: CTAR_UNION,
    ...
    pub rser: RSER,
    #[doc = "PUSH TX FIFO Register In Slave Mode PUSH TX FIFO Register In Master Mode"]
    pub pushr: PUSHR_UNION,
