...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub fn spi1_ctar_slave(&self) -> &crate::Reg<spi1_ctar_slave::SPI1_CTAR_SLAVE_SPEC> {
        unsafe {
            &*(((self as *const Self) as *const u8).add(12usize)
                as *const crate::Reg<spi1_ctar_slave::SPI1_CTAR_SLAVE_SPEC>)
        }
    }
    #[doc = "0x0c..0x14 - Clock and Transfer Attributes Register (In Master Mode)"]
    #[inline(always)]
    pub fn spi1_ctar(&self) -> &[crate::Reg<spi1_ctar::SPI1_CTAR_SPEC>; 2] {
        unsafe {
            &*(((self as *const Self) as *const u8).add(12usize)
                as *const [crate::Reg<spi1_ctar::SPI1_CTAR_SPEC>; 2])
        }
    }
    #[doc = "0x34 - PUSH TX FIFO Register In Slave Mode"]
    #[inline(always)]
    pub fn spi1_pushr_slave(&self) -> &crate::Reg<spi1_pushr_slave::SPI1_PUSHR_SLAVE_SPEC> {
        unsafe {
            &*(((self as *const Self) as *const u8).add(52usize)
                as *const crate::Reg<spi1_pushr_slave::SPI1_PUSHR_SLAVE_SPEC>)
        }
    }
    #[doc = "0x34 - PUSH TX FIFO Register In Master Mode"]
    #[inline(always)]
    pub fn spi1_pushr(&self) -> &crate::Reg<spi1_pushr::SPI1_PUSHR_SPEC> {
        unsafe {
            &*(((self as *const Self) as *const u8).add(52usize)
                as *const crate::Reg<spi1_pushr::SPI1_PUSHR_SPEC>)
        }
    }
}
...
pub mod tcr;
#[doc = "SPI1_CTAR register accessor: an alias for `Reg<SPI1_CTAR_SPEC>`"]
pub type SPI1_CTAR = crate::Reg<spi1_ctar::SPI1_CTAR_SPEC>;
#[doc = "Clock and Transfer Attributes Register (In Master Mode)"]
pub mod spi1_ctar;
#[doc = "SPI1_CTAR_SLAVE register accessor: an alias for `Reg<SPI1_CTAR_SLAVE_SPEC>`"]
...
pub mod rser;
#[doc = "SPI1_PUSHR register accessor: an alias for `Reg<SPI1_PUSHR_SPEC>`"]
pub type SPI1_PUSHR = crate::Reg<spi1_pushr::SPI1_PUSHR_SPEC>;
#[doc = "PUSH TX FIFO Register In Master Mode"]
pub mod spi1_pushr;
#[doc = "SPI1_PUSHR_SLAVE register accessor: an alias for `Reg<SPI1_PUSHR_SLAVE_SPEC>`"]
