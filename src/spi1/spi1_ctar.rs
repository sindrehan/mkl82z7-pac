...
pub struct R(crate::R<SPI1_CTAR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPI1_CTAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPI1_CTAR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPI1_CTAR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CTAR%s` writer"]
pub struct W(crate::W<SPI1_CTAR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPI1_CTAR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPI1_CTAR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPI1_CTAR_SPEC>) -> Self {
        W(writer)
    }
}
