...
#[doc = "Possible values of the field `COMBINE1`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum COMBINE1R {
...
impl COMBINE1R {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> COMBINE1R {
        match value {
            false => COMBINE1R::_0,
            true => COMBINE1R::_1,
        }
...
#[doc = "Possible values of the field `COMSWAP1`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum COMSWAP1R {
    #[doc = "Even channel is used for input capture and 1st compare."]
    _0,
...
impl COMSWAP1R {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> COMSWAP1R {
        match value {
            false => COMSWAP1R::_0,
            true => COMSWAP1R::_1,
        }
...
#[doc = "Possible values of the field `COMBINE2`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum COMBINE2R {
...
impl COMBINE2R {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> COMBINE2R {
        match value {
            false => COMBINE2R::_0,
            true => COMBINE2R::_1,
        }
...
#[doc = "Possible values of the field `COMSWAP2`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum COMSWAP2R {
    #[doc = "Even channel is used for input capture and 1st compare."]
    _0,
...
impl COMSWAP2R {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> COMSWAP2R {
        match value {
            false => COMSWAP2R::_0,
            true => COMSWAP2R::_1,
        }
...
#[doc = "Values that can be written to the field `COMBINE1`"]
pub enum COMBINE1W {
    #[doc = "Channels 2 and 3 are independent."]
    _0,
    #[doc = "Channels 2 and 3 are combined."]
...
impl<'a> _COMBINE1W<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: COMBINE1W) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(COMBINE1W::_0)
    }
    #[doc = "Channels 2 and 3 are combined."]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(COMBINE1W::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `COMSWAP1`"]
pub enum COMSWAP1W {
    #[doc = "Even channel is used for input capture and 1st compare."]
    _0,
    #[doc = "Odd channel is used for input capture and 1st compare."]
...
#[doc = r" Proxy"]
pub struct _COMSWAP1W<'a> {
    w: &'a mut W,
}
impl<'a> _COMSWAP1W<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: COMSWAP1W) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(COMSWAP1W::_0)
    }
    #[doc = "Odd channel is used for input capture and 1st compare."]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(COMSWAP1W::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `COMBINE2`"]
pub enum COMBINE2W {
    #[doc = "Channels 4 and 5 are independent."]
    _0,
    #[doc = "Channels 4 and 5 are combined."]
...
impl<'a> _COMBINE2W<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: COMBINE2W) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(COMBINE2W::_0)
    }
    #[doc = "Channels 4 and 5 are combined."]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(COMBINE2W::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
#[doc = "Values that can be written to the field `COMSWAP2`"]
pub enum COMSWAP2W {
    #[doc = "Even channel is used for input capture and 1st compare."]
    _0,
    #[doc = "Odd channel is used for input capture and 1st compare."]
...
#[doc = r" Proxy"]
pub struct _COMSWAP2W<'a> {
    w: &'a mut W,
}
impl<'a> _COMSWAP2W<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: COMSWAP2W) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(COMSWAP2W::_0)
    }
    #[doc = "Odd channel is used for input capture and 1st compare."]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(COMSWAP2W::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[inline]
    pub fn comswap1(&self) -> COMSWAP1R {
        COMSWAP1R::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 9;
            ((self.bits >> OFFSET) & MASK as u32) != 0
    ...
    #[inline]
    pub fn comswap2(&self) -> COMSWAP2R {
        COMSWAP2R::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 17;
            ((self.bits >> OFFSET) & MASK as u32) != 0
...
impl W {
    ...
    #[doc = "Bit 9 - Combine Channels 2 and 3 Swap"]
    #[inline]
    pub fn comswap1(&mut self) -> _COMSWAP1W {
        _COMSWAP1W { w: self }
    }
    #[doc = "Bit 16 - Combine Channels 4 and 5"]
    #[inline]
    ...
    #[doc = "Bit 17 - Combine Channels 4 and 5 Swap"]
    #[inline]
    pub fn comswap2(&mut self) -> _COMSWAP2W {
        _COMSWAP2W { w: self }
    }
}
