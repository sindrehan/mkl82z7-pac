#[doc = "Reader of register TRNG0_FRQMAX"]
pub type R = crate::R<u32, super::TRNG0_FRQMAX>;
#[doc = "Writer for register TRNG0_FRQMAX"]
pub type W = crate::W<u32, super::TRNG0_FRQMAX>;
#[doc = "Register TRNG0_FRQMAX `reset()`'s with value 0x6400"]
impl crate::ResetValue for super::TRNG0_FRQMAX {
    type Type = u32;
    #[inline(always)]
