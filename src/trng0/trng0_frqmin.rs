#[doc = "Reader of register TRNG0_FRQMIN"]
pub type R = crate::R<u32, super::TRNG0_FRQMIN>;
#[doc = "Writer for register TRNG0_FRQMIN"]
pub type W = crate::W<u32, super::TRNG0_FRQMIN>;
#[doc = "Register TRNG0_FRQMIN `reset()`'s with value 0x0640"]
impl crate::ResetValue for super::TRNG0_FRQMIN {
    type Type = u32;
    #[inline(always)]
