#[doc = "Reader of register TRNG0_INT_MASK"]
pub type R = crate::R<u32, super::TRNG0_INT_MASK>;
#[doc = "Writer for register TRNG0_INT_MASK"]
pub type W = crate::W<u32, super::TRNG0_INT_MASK>;
#[doc = "Register TRNG0_INT_MASK `reset()`'s with value 0"]
impl crate::ResetValue for super::TRNG0_INT_MASK {
    type Type = u32;
    #[inline(always)]
