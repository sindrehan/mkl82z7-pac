#[doc = "Reader of register TRNG0_SCML"]
pub type R = crate::R<u32, super::TRNG0_SCML>;
#[doc = "Writer for register TRNG0_SCML"]
pub type W = crate::W<u32, super::TRNG0_SCML>;
#[doc = "Register TRNG0_SCML `reset()`'s with value 0x010c_0568"]
impl crate::ResetValue for super::TRNG0_SCML {
    type Type = u32;
    #[inline(always)]
