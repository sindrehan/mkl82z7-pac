#[doc = "Reader of register TRNG0_SCR1L"]
pub type R = crate::R<u32, super::TRNG0_SCR1L>;
#[doc = "Writer for register TRNG0_SCR1L"]
pub type W = crate::W<u32, super::TRNG0_SCR1L>;
#[doc = "Register TRNG0_SCR1L `reset()`'s with value 0x00b2_0195"]
impl crate::ResetValue for super::TRNG0_SCR1L {
    type Type = u32;
    #[inline(always)]
