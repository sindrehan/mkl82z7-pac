#[doc = "Reader of register TRNG0_SCR2L"]
pub type R = crate::R<u32, super::TRNG0_SCR2L>;
#[doc = "Writer for register TRNG0_SCR2L"]
pub type W = crate::W<u32, super::TRNG0_SCR2L>;
#[doc = "Register TRNG0_SCR2L `reset()`'s with value 0x007a_00dc"]
impl crate::ResetValue for super::TRNG0_SCR2L {
    type Type = u32;
    #[inline(always)]
