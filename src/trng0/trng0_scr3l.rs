#[doc = "Reader of register TRNG0_SCR3L"]
pub type R = crate::R<u32, super::TRNG0_SCR3L>;
#[doc = "Writer for register TRNG0_SCR3L"]
pub type W = crate::W<u32, super::TRNG0_SCR3L>;
#[doc = "Register TRNG0_SCR3L `reset()`'s with value 0x0058_007d"]
impl crate::ResetValue for super::TRNG0_SCR3L {
    type Type = u32;
    #[inline(always)]
