#[doc = "Reader of register TRNG0_SCR5L"]
pub type R = crate::R<u32, super::TRNG0_SCR5L>;
#[doc = "Writer for register TRNG0_SCR5L"]
pub type W = crate::W<u32, super::TRNG0_SCR5L>;
#[doc = "Register TRNG0_SCR5L `reset()`'s with value 0x002e_002f"]
impl crate::ResetValue for super::TRNG0_SCR5L {
    type Type = u32;
    #[inline(always)]
