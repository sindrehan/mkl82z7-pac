#[doc = "Reader of register TRNG0_SCR6PL"]
pub type R = crate::R<u32, super::TRNG0_SCR6PL>;
#[doc = "Writer for register TRNG0_SCR6PL"]
pub type W = crate::W<u32, super::TRNG0_SCR6PL>;
#[doc = "Register TRNG0_SCR6PL `reset()`'s with value 0x002e_002f"]
impl crate::ResetValue for super::TRNG0_SCR6PL {
    type Type = u32;
    #[inline(always)]
