#[doc = "Reader of register TRNG0_SDCTL"]
pub type R = crate::R<u32, super::TRNG0_SDCTL>;
#[doc = "Writer for register TRNG0_SDCTL"]
pub type W = crate::W<u32, super::TRNG0_SDCTL>;
#[doc = "Register TRNG0_SDCTL `reset()`'s with value 0x0c80_09c4"]
impl crate::ResetValue for super::TRNG0_SDCTL {
    type Type = u32;
    #[inline(always)]
