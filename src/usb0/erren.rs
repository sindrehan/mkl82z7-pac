...
#[doc = "Possible values of the field `OWNERREN`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum OWNERRENR {
...
impl OWNERRENR {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> OWNERRENR {
        match value {
            false => OWNERRENR::_0,
            true => OWNERRENR::_1,
        }
...
#[doc = "Values that can be written to the field `OWNERREN`"]
pub enum OWNERRENW {
    #[doc = "Disables the OWNERR interrupt."]
    _0,
    #[doc = "Enables the OWNERR interrupt."]
...
#[doc = r" Proxy"]
pub struct _OWNERRENW<'a> {
    w: &'a mut W,
}
impl<'a> _OWNERRENW<'a> {
    #[doc = r" Writes `variant` to the field"]
    #[inline]
    pub fn variant(self, variant: OWNERRENW) -> &'a mut W {
        {
            self.bit(variant._bits())
        }
    }
    ...
    #[inline]
    pub fn _0(self) -> &'a mut W {
        self.variant(OWNERRENW::_0)
    }
    #[doc = "Enables the OWNERR interrupt."]
    #[inline]
    pub fn _1(self) -> &'a mut W {
        self.variant(OWNERRENW::_1)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[doc = "Bit 6 - OWNERR Interrupt Enable"]
    #[inline]
    pub fn ownerren(&mut self) -> _OWNERRENW {
        _OWNERRENW { w: self }
    }
    #[doc = "Bit 7 - BTSERR Interrupt Enable"]
    #[inline]
