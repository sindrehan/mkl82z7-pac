...
#[doc = "Field `NID` reader - Ones' complement of PERID\\[ID\\]
bits."]
pub struct NID_R(crate::FieldReader<u8, u8>);
impl NID_R {
    pub(crate) fn new(bits: u8) -> Self {
        NID_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for NID_R {
...
impl R {
    #[doc = "Bits 0:5 - Ones' complement of PERID\\[ID\\]
bits."]
    #[inline(always)]
