...
pub struct R(crate::R<STALL_IH_DIS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<STALL_IH_DIS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<STALL_IH_DIS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<STALL_IH_DIS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `STALL_IH_DIS` writer"]
pub struct W(crate::W<STALL_IH_DIS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<STALL_IH_DIS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<STALL_IH_DIS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<STALL_IH_DIS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct STALL_I_DIS8_R(crate::FieldReader<bool, STALL_I_DIS8_A>);
impl STALL_I_DIS8_R {
    pub(crate) fn new(bits: bool) -> Self {
        STALL_I_DIS8_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for STALL_I_DIS8_R {
    type Target = crate::FieldReader<bool, STALL_I_DIS8_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct STALL_I_DIS9_R(crate::FieldReader<bool, STALL_I_DIS9_A>);
impl STALL_I_DIS9_R {
    pub(crate) fn new(bits: bool) -> Self {
        STALL_I_DIS9_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for STALL_I_DIS9_R {
    type Target = crate::FieldReader<bool, STALL_I_DIS9_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct STALL_I_DIS10_R(crate::FieldReader<bool, STALL_I_DIS10_A>);
impl STALL_I_DIS10_R {
    pub(crate) fn new(bits: bool) -> Self {
        STALL_I_DIS10_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for STALL_I_DIS10_R {
    type Target = crate::FieldReader<bool, STALL_I_DIS10_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct STALL_I_DIS11_R(crate::FieldReader<bool, STALL_I_DIS11_A>);
impl STALL_I_DIS11_R {
    pub(crate) fn new(bits: bool) -> Self {
        STALL_I_DIS11_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for STALL_I_DIS11_R {
    type Target = crate::FieldReader<bool, STALL_I_DIS11_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct STALL_I_DIS12_R(crate::FieldReader<bool, STALL_I_DIS12_A>);
impl STALL_I_DIS12_R {
    pub(crate) fn new(bits: bool) -> Self {
        STALL_I_DIS12_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for STALL_I_DIS12_R {
    type Target = crate::FieldReader<bool, STALL_I_DIS12_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct STALL_I_DIS13_R(crate::FieldReader<bool, STALL_I_DIS13_A>);
impl STALL_I_DIS13_R {
    pub(crate) fn new(bits: bool) -> Self {
        STALL_I_DIS13_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for STALL_I_DIS13_R {
    type Target = crate::FieldReader<bool, STALL_I_DIS13_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct STALL_I_DIS14_R(crate::FieldReader<bool, STALL_I_DIS14_A>);
impl STALL_I_DIS14_R {
    pub(crate) fn new(bits: bool) -> Self {
        STALL_I_DIS14_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for STALL_I_DIS14_R {
    type Target = crate::FieldReader<bool, STALL_I_DIS14_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
pub struct STALL_I_DIS15_R(crate::FieldReader<bool, STALL_I_DIS15_A>);
impl STALL_I_DIS15_R {
    pub(crate) fn new(bits: bool) -> Self {
        STALL_I_DIS15_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for STALL_I_DIS15_R {
    type Target = crate::FieldReader<bool, STALL_I_DIS15_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
