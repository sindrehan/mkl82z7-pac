...
#[doc = "Possible values of the field `VREDG_DET`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum VREDG_DETR {
    #[doc = "VREGIN rising edge interrupt has not been detected."]
    _0,
    #[doc = "VREGIN rising edge interrupt has been detected."]
    _1,
}
impl VREDG_DETR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> VREDG_DETR {
        match value {
            false => VREDG_DETR::_0,
            true => VREDG_DETR::_1,
        }
...
#[doc = "Possible values of the field `VFEDG_DET`"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum VFEDG_DETR {
    #[doc = "VREGIN falling edge interrupt has not been detected."]
    _0,
    #[doc = "VREGIN falling edge interrupt has been detected."]
    _1,
}
impl VFEDG_DETR {
    #[doc = r" Returns `true` if the bit is clear (0)"]
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> VFEDG_DETR {
        match value {
            false => VFEDG_DETR::_0,
            true => VFEDG_DETR::_1,
        }
...
impl R {
    ...
    #[inline]
    pub fn vredg_det(&self) -> VREDG_DETR {
        VREDG_DETR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u8) != 0
    ...
    #[inline]
    pub fn vfedg_det(&self) -> VFEDG_DETR {
        VFEDG_DETR::_from({
            const MASK: bool = true;
            const OFFSET: u8 = 4;
            ((self.bits >> OFFSET) & MASK as u8) != 0
